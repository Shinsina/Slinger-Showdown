...
class Scoreboard:
    ...
    def prep_score(self):
        ...
        self.score_image = self.font.render(score_str, True, self.text_color, (230, 230, 230))
    ...
    def prep_timeboosts(self):
        ...
        self.tb_image = self.font.render(timeboosts_total, True, self.text_color, (230,230,230))
    ...
    def prep_lapcount(self):
        ...
        self.lc_image = self.font.render(lapcount, True, self.text_color, (230,230,230))
